...
\newcommand{\cvtitlelocation}[1]{\renewcommand{\cvtitlelocationvar}{\faMapMarker* #1}}

\newcommand{\cvlinkedin}[1]{\renewcommand{\cvlinkedinvar}{\faLinkedin\ \href{https://linkedin.com/in/#1}{#1}}}

\newcommand{\cvemail}[1]{\renewcommand{\cvemailvar}{\faEnvelope[regular] \href{mailto:#1}{\texttt{#1}}}}

\newcommand{\cvphone}[2]{\renewcommand{\cvphonevar}{\faPhone* \href{#1}{\texttt{#2}}}}
...
\newcommand{\cvtitle}{
  \begin{center}
    ...
    \begin{tabular}{ll}
      \cvtitlelocationvar & \cvlinkedinvar \\
      \cvphonevar & \cvemailvar
    \end{tabular}
  \end{center}
}
...
\cvphone{https://wa.me/59895059121}{+598~9505~9121}
...
\begin{cveducation}
  ...
  {Engineer’s Degree in Nuclear and Energy Technologies \emph{(Cum Laude)}}
...
\begin{cvexperience}
  ...
  \begin{cvjob}
    \cvposition{Senior Software Developer Engineer}{Dualboot Partners}
    ...
    \begin{itemize}
      ...
      \begin{itemize}
        \item Participating in the definition and development of integrations with external vendors, customization, 
        feature implementation, and bug-fixing. \cvskills{Scala, Kotlin, Micronaut, MySQL, PostgreSQL, Docker, Git, JavaScript}
        \item Deploying to production and lower environments, monitoring correct behavior. 
        \cvskills{Jenkins, Docker, GitHub Actions, Grafana}
        \item Offering support to the \emph{Market Operations Team}.
      \end{itemize}
    \end{itemize}
  \end{cvjob}
  
  \begin{cvjob}
    \cvposition{Senior Software Developer Engineer}{Agtium Corp}
...
\begin{cvlang}
  ...
  \cvlangitem{English}{Upper intermediate - B2}
\end{cvlang}
