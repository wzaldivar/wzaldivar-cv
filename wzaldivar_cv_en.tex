...
\begin{cvexperience}
  ...
  \begin{cvjob}
    ...
    \begin{itemize}
      \item Staff augmentation, IOT Integration Provider -- \emph{Developers Console Team}, \emph{US Client}\\\cvdate{6}{2024}-\cvdate{12}{2025}
      \begin{itemize}
        \item Participate in the proxying and integration of multiple internal backend services into a unified system, 
        customization, feature implementation, and bug-fixing. \cvskills{Kotlin, Groovy, Swagger, Ratpack, Docker, Git}
      \end{itemize}
    \item Internal project\\\cvdate{1}{2026}-\cvdate{2}{2026}
      \begin{itemize}
        \item Optimized data retrieval by implementing pagination and enhanced system reliability through integration testing
          \cvskills{Spring Boot, Kotlin, JUnit5, DynamoDB, AWS,Testcontainers, Git}
        \item Planned and started refactoring of the authentication architecture to decouple the SSO system, 
          facilitating provider switching \cvskills{Spring Boot, Kotlin, Git}
      \end{itemize}
    \end{itemize}
  \end{cvjob}
